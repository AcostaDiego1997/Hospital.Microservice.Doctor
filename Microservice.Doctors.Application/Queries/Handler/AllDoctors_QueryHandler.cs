...
{
    public class AllDoctors_QueryHandler : IRequestHandler<AllDoctors_Query, List<Doctor_DTO>>
    {
        ...
        public async Task<List<Doctor_DTO>> Handle(AllDoctors_Query request, CancellationToken cancellationToken)
        {
            try
            {
